...
function AdminUpload(){
    ...
    // Validate problemId on component mount
    useEffect(() => {
      if (!problemId) {
      ...
      const onSubmit = async (data) => {
        ...
        try {
          ...
          console.log('Requesting upload signature for problemId:', problemId);
        ...
        <div className="max-w-md mx-auto p-6">
          <div className="card bg-base-100 shadow-xl">
            <div className="card-body">
              <h2 className="card-title">Upload Video for Problem ID: {problemId}</h2>
